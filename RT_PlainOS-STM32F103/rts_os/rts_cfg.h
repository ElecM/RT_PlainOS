...
/**----------------------------- CPU硬件参数配置 ----------------------------------**/
#define  RTS_CFG_CPU_DATA_BITS          (32u)       /*< CPU寄存器的大小(Byte) */

#define  RTS_CFG_CPU_ADDR_BITS          (32u)      /*< 地址的大小(Byte) */
...
#define  RTS_CFG_DELAY_ENB              (1u)       /*< 任务延时功能 */
...
#define  MEM_POOL_SIZE                 (4096u)     /*< 设置内存池大小(Byte) */
