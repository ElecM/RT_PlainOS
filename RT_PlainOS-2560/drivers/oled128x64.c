...
#define SPI_CLK_1   gpio_spi.nor_self_data(&gpio_spi,(u8_t)(1<<3));
#define SPI_CLK_0   gpio_spi.and_self_data(&gpio_spi,(u8_t)(~(1<<3)));

#define SPI_MOSI_1  gpio_spi.nor_self_data(&gpio_spi,(u8_t)(1<<4));
#define SPI_MOSI_0  gpio_spi.and_self_data(&gpio_spi,(u8_t)(~(1<<4)));

#define SPI_CS_1    gpio_spi.nor_self_data(&gpio_spi,(u8_t)(1<<7));
#define SPI_CS_0    gpio_spi.and_self_data(&gpio_spi,(u8_t)(~(1<<7)));

#define SPI_DC_1    gpio_spi.nor_self_data(&gpio_spi,(u8_t)(1<<6));
#define SPI_DC_0    gpio_spi.and_self_data(&gpio_spi,(u8_t)(~(1<<6)));

#define SPI_RST_1   gpio_spi.nor_self_data(&gpio_spi,(u8_t)(1<<5));
#define SPI_RST_0   gpio_spi.and_self_data(&gpio_spi,(u8_t)(~(1<<5)));
